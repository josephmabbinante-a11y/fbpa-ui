...
const base = path.join(__dirname, 'multitenant');
...
write('migrations/001_initial_schema.sql', `-- Opscale Multi-Tenant Schema
...
// === src/config/env.js ===
write('src/config/env.js', `/* global process */
...
write('src/config/database.js', `import pg from 'pg';
...
// === src/utils/logger.js ===
write('src/utils/logger.js', `/* global process */
...
write('src/utils/errorHandler.js', `import { logger } from './logger.js';
...
write('src/middleware/auth.middleware.js', `import jwt from 'jsonwebtoken';
...
write('src/middleware/tenant.middleware.js', `import { AppError } from '../utils/errorHandler.js';
...
write('src/middleware/role.middleware.js', `import { AppError } from '../utils/errorHandler.js';
...
write('src/middleware/feature.middleware.js', `import { query } from '../config/database.js';
import { AppError } from '../utils/errorHandler.js';
...
// === src/middleware/impersonation.middleware.js ===
write('src/middleware/impersonation.middleware.js', `import { query } from '../config/database.js';
import { AppError } from '../utils/errorHandler.js';
...
write('src/modules/admin/admin.service.js', `import { query } from '../../config/database.js';
...
write('src/modules/auth/auth.service.js', `import bcrypt from 'bcryptjs';
...
write('src/modules/auth/auth.controller.js', `import { login, impersonate } from './auth.service.js';
import { AppError } from '../../utils/errorHandler.js';
...
write('src/modules/auth/auth.routes.js', `import { Router } from 'express';
...
write('src/modules/tenants/tenant.service.js', `import { query } from '../../config/database.js';
import { AppError } from '../../utils/errorHandler.js';
...
write('src/modules/tenants/tenant.controller.js', `import { createTenant, listTenants, getTenant, updateTenantStatus } from './tenant.service.js';
import { AppError } from '../../utils/errorHandler.js';
...
write('src/modules/tenants/tenant.routes.js', `import { Router } from 'express';
...
write('src/modules/users/user.service.js', `import bcrypt from 'bcryptjs';
import { query } from '../../config/database.js';
import { AppError } from '../../utils/errorHandler.js';
...
write('src/modules/users/user.controller.js', `import { createUser, listUsers, getUser } from './user.service.js';
import { AppError } from '../../utils/errorHandler.js';
...
write('src/modules/users/user.routes.js', `import { Router } from 'express';
...
write('src/modules/notifications/notification.service.js', `import { query } from '../../config/database.js';
...
// === src/modules/loads/load.service.js ===
write('src/modules/loads/load.service.js', `import { query } from '../../config/database.js';
import { AppError } from '../../utils/errorHandler.js';
...
// === src/modules/loads/load.controller.js ===
write('src/modules/loads/load.controller.js', `import * as loadService from './load.service.js';
import { AppError } from '../../utils/errorHandler.js';
...
// === src/modules/loads/load.routes.js ===
write('src/modules/loads/load.routes.js', `import { Router } from 'express';
...
// === src/modules/bids/bid.service.js ===
write('src/modules/bids/bid.service.js', `import { query } from '../../config/database.js';
import { AppError } from '../../utils/errorHandler.js';
...
export async function acceptBid(bidId, tenantId) {
  ...
  // Notify accepted carrier's user
...
// === src/modules/bids/bid.controller.js ===
write('src/modules/bids/bid.controller.js', `import * as bidService from './bid.service.js';
import { AppError } from '../../utils/errorHandler.js';
...
// === src/modules/bids/bid.routes.js ===
write('src/modules/bids/bid.routes.js', `import { Router } from 'express';
...
// === src/modules/carriers/carrier.service.js ===
write('src/modules/carriers/carrier.service.js', `import { query } from '../../config/database.js';
import { AppError } from '../../utils/errorHandler.js';
...
// === src/modules/carriers/carrier.controller.js ===
write('src/modules/carriers/carrier.controller.js', `import * as svc from './carrier.service.js';
...
// === src/modules/carriers/carrier.routes.js ===
write('src/modules/carriers/carrier.routes.js', `import { Router } from 'express';
...
write('src/modules/settings/settings.service.js', `import { query } from '../../config/database.js';
import { AppError } from '../../utils/errorHandler.js';
import { logAdminActivity } from '../admin/admin.service.js';
...
write('src/modules/settings/settings.controller.js', `import { getSettings, updateSettings } from './settings.service.js';
...
write('src/modules/settings/settings.routes.js', `import { Router } from 'express';
...
// === src/modules/features/feature.service.js ===
write('src/modules/features/feature.service.js', `import { query } from '../../config/database.js';
...
write('src/modules/admin/admin.controller.js', `import { setFeature, getFeatures } from '../features/feature.service.js';
...
write('src/modules/admin/admin.routes.js', `import { Router } from 'express';
...
// === src/server.js ===
write('src/server.js', `/* global process */
