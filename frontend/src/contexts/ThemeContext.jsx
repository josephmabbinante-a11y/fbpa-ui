...
const PALETTES = [
  {
    ...
    light: {
      ...
      bannerAccent: 'rgba(12, 13, 15, 0.67)',
      bannerGlow: 'none',
    },
    dark: {
      bg: '#0F1115',
  ...
  },
  {
    ...
    light: {
      ...
      error: '#B91C1C',
      secondary: '#64748B',
      bannerBg: 'linear-gradient(90deg, #FFFFFF 0%, #F1F5F9 100%)',
      bannerAccent: 'rgba(71, 85, 105, 0.22)',
      bannerGlow: 'none',
    },
    dark: {
      bg: '#0F172A',
      ...
      error: '#F87171',
      secondary: '#CBD5E1',
      bannerBg: 'linear-gradient(90deg, #1E293B 0%, #0F172A 100%)',
      bannerAccent: 'rgba(148, 163, 184, 0.28)',
      bannerGlow: '0 0 16px rgba(148, 163, 184, 0.14)',
    },
  },
  {
    id: 'industrial-steel',
  ...
  },
  {
    ...
    light: {
      ...
      error: '#FF1744',
      secondary: '#00BFA5',
      bannerBg: 'linear-gradient(90deg, #FFFBFE 0%, #FCF0F6 100%)',
      bannerAccent: 'rgba(233, 30, 99, 0.28)',
      bannerGlow: 'none',
    },
    dark: {
      bg: '#0D0D1A',
      ...
      error: '#FF5252',
      secondary: '#00E5FF',
      bannerBg: 'linear-gradient(110deg, #140A20 0%, #0D1A2A 100%)',
      bannerAccent: 'rgba(255, 64, 129, 0.35)',
      bannerGlow: '0 0 20px rgba(0, 230, 118, 0.18)',
    },
  },
  {
    id: 'minimal-white',
